...
class CsvImportFantasyPointsCommand extends Command
{
    protected static $defaultName = 'app:csv-import-fantasy-points';
    ...
    {
        $this
            ->setDescription('Import CSV points in the database.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $result = $this->csvImporter->importPoints($filePath);
