...
final class Version20201120192628 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE pick DROP FOREIGN KEY FK_99CD0F9BA76ED395');
        $this->addSql('ALTER TABLE ranking_evolution DROP FOREIGN KEY FK_5F1657AEA76ED395');
        $this->addSql('CREATE TABLE fantasy_pick (id INT AUTO_INCREMENT NOT NULL, fantasy_user_id INT NOT NULL, nba_player_id VARCHAR(255) NOT NULL, season INT NOT NULL, picked_at DATE NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_A0A75E6213BC7FA0 (fantasy_user_id), INDEX IDX_A0A75E6299A217B7 (nba_player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fantasy_team_ranking (id INT AUTO_INCREMENT NOT NULL, fantasy_team_id INT NOT NULL, season INT NOT NULL, fantasy_points INT NOT NULL, rank INT NOT NULL, ranking_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_1F19534E9DBE749B (fantasy_team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fantasy_user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, ttfl_id INT DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) DEFAULT NULL, registered_at DATETIME NOT NULL, last_login_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_B4F987B0F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fantasy_user_ranking (id INT AUTO_INCREMENT NOT NULL, fantasy_user_id INT NOT NULL, season INT NOT NULL, fantasy_points INT NOT NULL, ranking INT NOT NULL, ranking_at DATE NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_B86D3C7313BC7FA0 (fantasy_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nba_game (id VARCHAR(255) NOT NULL, local_nba_team_id VARCHAR(255) NOT NULL, visitor_nba_team_id VARCHAR(255) NOT NULL, season INT NOT NULL, game_day DATE NOT NULL, scheduled_at DATETIME DEFAULT NULL, local_score INT DEFAULT NULL, visitor_score INT DEFAULT NULL, updated_at DATETIME NOT NULL, INDEX IDX_C7EE5A59A420D96C (local_nba_team_id), INDEX IDX_C7EE5A59954637D5 (visitor_nba_team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nba_player (id VARCHAR(255) NOT NULL, nba_team_id VARCHAR(255) DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, position VARCHAR(255) NOT NULL, jersey VARCHAR(255) NOT NULL, is_injured TINYINT(1) NOT NULL, average_fantasy_points DOUBLE PRECISION DEFAULT NULL, past_year_fantasy_points DOUBLE PRECISION DEFAULT NULL, updated_at DATETIME NOT NULL, INDEX IDX_BE36172ACF29ABC2 (nba_team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE nba_team (id VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, nickname VARCHAR(255) NOT NULL, tricode VARCHAR(255) NOT NULL, conference VARCHAR(255) NOT NULL, division VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('DROP TABLE ranking_evolution');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pick (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nba_player_id VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, picked_at DATE NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_99CD0F9B99A217B7 (nba_player_id), INDEX IDX_99CD0F9BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE ranking_evolution (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, fantasy_points INT NOT NULL, ranking INT NOT NULL, ranking_at DATE NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_5F1657AEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:json)\', password VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, registered_at DATETIME NOT NULL, last_login_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE pick ADD CONSTRAINT FK_99CD0F9BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE ranking_evolution ADD CONSTRAINT FK_5F1657AEA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
